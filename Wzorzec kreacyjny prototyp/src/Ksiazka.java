...
public class Ksiazka implements KsiazkaKlon {
    public String tytul;
    public String autor;
    public String IBSN;
    ...
    @Override
    public Ksiazka klonuj() {
        Random random = new Random();
        String IBSN = String.valueOf(random.nextInt(100000));
        Ksiazka ksiazka = new Ksiazka(tytul,autor,IBSN,wydawnictwo);
        return ksiazka;
    }
}