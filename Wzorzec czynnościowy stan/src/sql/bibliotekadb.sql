...
--
-- Host: 127.0.0.1
-- Czas generowania: 01 Gru 2020, 12:11
...
INSERT INTO `ksiazka` (`ID_ksiazki`, `Autor`, `Tytul`, `ISBN`, `Wydawnictwo`, `Status`, `ID_uzytkownika`, `Data_wypozyczenia`, `Jezyk`) VALUES
(1, 'Henryk Sienkiewicz', 'Krzyzacy', '78654', 'Bellona', 0, 1, '2021-05-18', 'polski'),
(2, 'Boleslaw Prus', 'Lalka', '54786', 'Greg', 1, NULL, NULL, 'polski'),
(3, 'Fiodor Dostojewski', 'Zbrodnia i kara', '89321', 'Greg', 0, 1, '2021-01-01', 'polski'),
(4, 'Osamu Dazai', 'Zatracenie', '75908', 'Czytelnik', 1, NULL, NULL, 'polski'),
(5, 'Arthur Conan Doyle', 'Sherlock Holmes', '76590', 'Zysk', 1, NULL, NULL, 'angielski');
