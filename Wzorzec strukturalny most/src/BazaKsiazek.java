...
public class BazaKsiazek {
    ...
    public void usun() {
        ...
        nazwa = scanner1.nextLine();
        if(nazwa.toLowerCase().equals("ksiazka")){
            System.out.print("Podaj autora: ");
    ...
    public String[] wyszukaj(String tytul, String autor) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                ksiazka[6] = rs.getString("Fragment");
            }
            con.close();
            return ksiazka;
        } catch (Exception e) {
    ...
    public String wyszukaj(String nazwa) {  //do czasopisma
        ...
        try {
            ...
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/bibliotekadb",
                    ...
                    "");
            Statement statement = con.createStatement();
            String sql = "SELECT ksiazka.Fragment\n" +
                    "FROM ksiazka \n" +
                    "WHERE ksiazka.tytul = '" + nazwa + "'; ";
            ResultSet rs = statement.executeQuery(sql);
            while (rs.next()){
