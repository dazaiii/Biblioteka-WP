...
public class BazaKsiazek {
    public void dodaj() {
        ...
        try{
            ...
            statement.executeUpdate("INSERT INTO ksiazka(Autor, Tytul, ISBN, Wydawnictwo, Status, Jezyk) VALUES (" + "'" + autor + "','" + tytul + "','" + ISBN +"','" + wydawnictwo+"'," + "1" + ", " + jezyk + ");");
            con.close();
        }catch (Exception e) {
