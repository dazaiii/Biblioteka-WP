public class KsiazkaPolskojezyczna implements Ksiazka {
    public String tytul;
    public String autor;
    public String IBSN;
    public String wydawnictwo;

    public KsiazkaPolskojezyczna(){

    }

    public KsiazkaPolskojezyczna(String tytul, String autor, String IBSN, String wydawnictwo) {
        this.tytul = tytul;
        this.autor = autor;
        this.IBSN = IBSN;
